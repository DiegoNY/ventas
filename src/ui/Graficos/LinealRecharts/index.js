...
function RechartsLineal({ datos, dataKey, aspect, height, fill, nameX, fillX }) {
    ...
    return (
        <>
            <ResponsiveContainer width="100%" height={height || '100%'} aspect={aspect}>
                ...
                >
                    <XAxis dataKey={nameX || "name"} tick={<CustomizedXAxisTick className="text-xs text-center " fill={fillX || fill} />} tickLine={false} />
